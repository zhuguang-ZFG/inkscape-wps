...
class QUtiMimeConverter(PyQt6.sip.simplewrapper):
    ...
    def count(self, mimeData: QtCore.QMimeData|None) -> int: ...
    def convertToMime(self, mime: str|None, data: collections.abc.Iterable[QtCore.QByteArray|bytes|bytearray|memoryview], uti: str|None) -> typing.Any: ...
    def mimeForUti(self, uti: str|None) -> str: ...
    def utiForMime(self, mime: str|None) -> str: ...
    def convertFromMime(self, mime: str|None, data: typing.Any, uti: str|None) -> list[QtCore.QByteArray]: ...
    def canConvert(self, mime: str|None, uti: str|None) -> bool: ...
